export const messages = {
  de: {
    ...
    "config.riseTime.disabledHint": "Geplante Backzeit zuerst löschen, um die Gehzeit anzupassen",
  ...
  en: {
    ...
    "config.riseTime.disabledHint": "Clear the scheduled bake time first to adjust the rise time",
